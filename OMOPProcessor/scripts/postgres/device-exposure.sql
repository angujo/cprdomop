...
SELECT 
type_concept_id device_type_concept_id, stem_table.id device_exposure_id, person_id, concept_id device_concept_id, start_date::date device_exposure_start_date, 
start_datetime::timestamp device_exposure_start_datetime, end_date::date device_exposure_end_date, end_date::timestamp device_exposure_end_datetime, NULL unique_device_id, 
