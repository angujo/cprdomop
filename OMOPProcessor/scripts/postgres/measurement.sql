...
SELECT 
stem_table.id measurement_id, source_value measurement_source_value, unit_source_value, value_source_value, null measurement_time, person_id, concept_id measurement_concept_id, 
start_date measurement_date, start_datetime measurement_datetime, type_concept_id measurement_type_concept_id, operator_concept_id::numeric, value_as_number::numeric, value_as_concept_id, 
