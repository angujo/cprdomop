...
SELECT 
source_value procedure_source_value,stem_table.id procedure_occurrence_id, person_id, concept_id procedure_concept_id, start_date procedure_date, start_datetime procedure_datetime, 
