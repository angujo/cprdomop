...
CREATE UNIQUE INDEX xpk_concept_ancestor ON {sc}.concept_ancestor USING btree (ancestor_concept_id, descendant_concept_id);

CREATE UNIQUE INDEX idx_concept_class_class_id ON {sc}.concept_class USING btree (concept_class_id);

CREATE UNIQUE INDEX xpk_concept_class ON {sc}.concept_class USING btree (concept_class_id);
...
CREATE UNIQUE INDEX xpk_concept_relationship ON {sc}.concept_relationship USING btree (concept_id_1, concept_id_2, relationship_id);
...
CREATE UNIQUE INDEX xpk_relationship ON {sc}.relationship USING btree (relationship_id);

CREATE UNIQUE INDEX idx_vocabulary_vocabulary_id ON {sc}.vocabulary USING btree (vocabulary_id);

CREATE UNIQUE INDEX xpk_vocabulary ON {sc}.vocabulary USING btree (vocabulary_id);
